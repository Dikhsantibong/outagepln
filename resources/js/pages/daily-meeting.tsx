...
/**
 * Menu Rapat Outage yang baru.
 *
 * Berbeda dari Daily Meeting (/daily-meetings) yang sudah berjalan — menu ini
        ...
        <>
            ...
            <div className="flex min-h-[70vh] flex-1 flex-col items-center justify-center p-8">
                <div className="flex flex-col items-center gap-4 text-center">
                    ...
                    <h2 className="text-xl font-semibold text-foreground">Rapat Outage</h2>
...
DailyMeeting.layout = {
    breadcrumbs: [{ title: 'Rapat Outage', href: '/daily-meeting' }],
};
