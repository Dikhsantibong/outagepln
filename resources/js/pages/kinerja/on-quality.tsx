                ...
                <Card className="w-full max-w-lg border-dashed border-2 border-primary/20 bg-primary/5 shadow-none">
                    <CardContent className="flex flex-col items-center text-center py-16 px-8 gap-6">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed max-w-md">
                            Modul pemantauan kualitas pelaksanaan outage sedang dalam tahap pengembangan. 
                            Fitur ini akan menyediakan analisis komprehensif terkait standar mutu, 
                            hasil inspeksi, dan kepatuhan terhadap prosedur pemeliharaan.
                        </p>
