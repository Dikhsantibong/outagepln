                ...
                <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white flex items-center justify-center p-6">
                    <div className="text-center max-w-sm">
                        ...
                        <div className="bg-white rounded-xl border p-4 text-left text-sm space-y-1">
                            <p className="font-semibold text-zinc-700">{briefing.judul}</p>
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-6 shadow-lg">
                    <div className="max-w-md mx-auto">
                        ...
                        <h1 className="text-xl font-bold">{briefing.judul}</h1>
                        <p className="text-blue-100 text-sm mt-1">
                            {new Date(briefing.tanggal).toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
                            {briefing.waktu_mulai && ` • ${briefing.waktu_mulai.slice(0, 5)}`}
                            {briefing.lokasi && ` • ${briefing.lokasi}`}
                        </p>
                    </div>
                </div>
