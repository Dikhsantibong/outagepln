...
class DailyBriefingExport implements FromView, WithColumnWidths, WithStyles, WithDrawings
{
    protected $briefing;

    public function __construct(DailyBriefing $briefing)
    {
    ...
    {
        return view('exports.daily-briefing-excel', [
