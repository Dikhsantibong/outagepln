 ...
 */
class MeetingKickoffExport implements FromView, WithColumnWidths, WithStyles, WithDrawings
{
    public function __construct(
        private DailyMeeting $meeting,
        private $kickoff,
        private $photos,
        private $attendees,
    ...
    {
        return view('exports.meeting-kickoff-excel', [
